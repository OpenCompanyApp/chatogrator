...
use OpenCompany\Chatogrator\Adapters\Linear\LinearCardRenderer;
...
/**
 * Tests for rendering Card objects to Linear-compatible markdown.
 *
 * Ported from adapter-linear/src/cards.test.ts.
 *
 * @group linear
 */
class LinearCardRendererTest extends TestCase
{
    private LinearCardRenderer $renderer;

    protected function setUp(): void
    {
        parent::setUp();
        $this->renderer = new LinearCardRenderer;
    }
